...
use gummiworm::archive_getter::{Message, get_file_contents};
...
async fn main() {
    ...
    println!("local res: {:?}", res);


    let remote_msg: &str = "{\"event_type\":\"mod\", \"file_path\":\"https://c088-74-72-159-164.ngrok.io/file.txtxx\", \"context\":\"remoter\"}";
